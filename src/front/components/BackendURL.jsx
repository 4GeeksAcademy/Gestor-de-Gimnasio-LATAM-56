// src/front/js/components/BackendURL.jsx

import React from "react";
import envFile from "../../../docs/assets/env-file.png";

// Valor por defecto (para las llamadas fetch)
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || "http://localhost:3001";

// Componente UI que el proyecto usa para mostrar instrucciones (export nombrado)
...
// Export por defecto: string con la URL que usan los fetchs

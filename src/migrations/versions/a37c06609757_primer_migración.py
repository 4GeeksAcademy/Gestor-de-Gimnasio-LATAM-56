...
Revision ID: a37c06609757
Revises: 
Create Date: 2025-12-02 06:53:27.603248
...
def upgrade():
    ...
    op.create_table('perfil_corporal',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('usuario_id', sa.Integer(), nullable=False),
    ...
    sa.Column('fecha_registro', sa.DateTime(), nullable=True),
    sa.Column('cuello', sa.Float(), nullable=True),
    sa.Column('pecho', sa.Float(), nullable=True),
    sa.Column('cintura', sa.Float(), nullable=True),
    sa.Column('cadera', sa.Float(), nullable=True),
    sa.Column('muslo_izq', sa.Float(), nullable=True),
    sa.Column('muslo_der', sa.Float(), nullable=True),
    sa.Column('pantorrilla_izq', sa.Float(), nullable=True),
    sa.Column('pantorrilla_der', sa.Float(), nullable=True),
    sa.Column('brazo_izq', sa.Float(), nullable=True),
    sa.Column('brazo_der', sa.Float(), nullable=True),
    sa.Column('antebrazo_izq', sa.Float(), nullable=True),
    sa.Column('antebrazo_der', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['usuario_id'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade():
    ...
    op.drop_table('historial_progreso')
    with op.batch_alter_table('usuarios', schema=None) as batch_op:
